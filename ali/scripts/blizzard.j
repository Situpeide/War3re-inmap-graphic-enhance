...
call SetCameraField(CAMERA_FIELD_FIELD_OF_VIEW, 80.00, 1 )
call SetCameraField(CAMERA_FIELD_ANGLE_OF_ATTACK, 309.00, 1 )
call SetTerrainFogEx(0,1250,5000,1,0.5,0.6,0.8)
...
call SetCineFilterStartUV(0, 0, 1, 1)
call SetCineFilterEndUV(0, 0, 1, 1)
call SetCineFilterStartColor(133, 133, 133, 222)
call SetCineFilterEndColor(133, 133, 133, 222)
